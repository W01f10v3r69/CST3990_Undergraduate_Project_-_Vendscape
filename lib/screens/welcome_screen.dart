          ...
          children: [
            ...
            Column(
              children: [
                ...
                Text('Ready to Order From The Nearest Vendor?', style: TextStyle(color: Colors.grey),),
                SizedBox(
                  height: 20,
                ),
                FlatButton(
                ...
                FlatButton(
                  child: RichText(text: TextSpan(
                      ...
                      children: [
                        TextSpan(
                            text: 'Login', style: TextStyle(fontWeight: FontWeight.bold, color: Colors.lightBlue)
                        )
                      ]
                  )
                  ),
